export default [
  ...
  },
  {
    ...
    inputs: [
      ...
      {
        indexed: false,
        internalType: "enum ChohanDice.BetResult",
        name: "expected",
        type: "uint8",
      },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint8", name: "dice1", type: "uint8" },
      { internalType: "uint8", name: "dice2", type: "uint8" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [{ internalType: "address", name: "_table", type: "address" }],
    name: "setTable",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
